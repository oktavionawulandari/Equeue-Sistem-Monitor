<template>
    <AppMeta :title="`${startDate} - ${endDate}_${userName}_${categoryName}`">
        <link
            rel="icon"
    ...
    <div class="container">
        <div class="header d-flex align-items-center">
            ...
            />
            <div class="ms-3">
                <h1 class="report-title">LAPORAN LAYANAN</h1>
        ...
        <div class="pengelola mb-5">
            <p class="address">Pengelola: {{ userName }}</p>
...
const userName = computed(() => {
    const user = props.users.find((user) => user.id == props.searchUser);
    return user ? user.name : "Semua User";
});
