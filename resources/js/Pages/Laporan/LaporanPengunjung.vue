<template>
    <AppMeta title="Laporan Pengunjung" />

    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-sm-6">
                    <h1 class="m-0 text-uppercase">Laporan Pengunjung</h1>
                </div>
                <div class="col-sm-6">
...
watch(filters.value, (value) => {
    linkAction.value = `/laporan/pengunjung?startDate=${value.startDate}&endDate=${value.endDate}&searchCategory=${value.searchCategory}&submit=excel`;
});
...
const handleAction = (type) => {
    ...
    if (type === "pdf") {
        window.open(`/laporan/pengunjung?${params}`, "_blank");
    } else if (type === "excel") {
    }
};
</script>
