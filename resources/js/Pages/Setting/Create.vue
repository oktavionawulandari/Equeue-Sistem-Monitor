    ...
    <div>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <input v-model="form.instansi" type="text" required />
            </div>

            <div>
                <label>Logo</label>
                <input type="file" @change="handleFileUpload" />
                <img v-if="setting.logo" :src="setting.logoUrl" alt="Logo" width="100" />
            </div>
            ...
            <div>
                ...
                <textarea v-model="form.running_text"></textarea>
            </div>
            ...
            <div>
                ...
                <input v-model="form.primary" type="color" />
            </div>

            <div>
                <label>Secondary Color</label>
                <input v-model="form.secondary" type="color" />
            </div>
            ...
            <div>
                ...
                <input v-model="form.background" type="color" />
            </div>

            <div>
                <label>Text Color</label>
                <input v-model="form.text" type="color" />
            </div>
    ...
    data() {
        return {
            form: {
                ...
                running_text: this.setting.running_text || '',
                video: this.setting.video || '',
                primary: this.setting.primary || '#ffffff',
                secondary: this.setting.secondary || '#ffffff',
                accent: this.setting.accent || '#ffffff',
                background: this.setting.background || '#ffffff',
                text: this.setting.text || '#000000',
                logo: null,
            },
        };
    },
    methods: {
        ...
        async submit() {
            ...
            for (const key in this.form) {
             ...
             this.$inertia.post(this.route('settings.update'), formData);
        },
    },
};
</script> -->
