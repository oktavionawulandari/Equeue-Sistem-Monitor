<template>
            ...
            <div class="card">
              <div class="card-body">
                <form @submit.prevent="submitForm">
                  ...
                  <div class="form-group">
                    <label for="category_id">Jenis Instansi</label>
                    <select
                      class="form-control"
                      v-model="form.instansi_id"
                      :class="{ 'is-invalid': errors.instansi_id }"
                      id="instansi_id"
                      name="instansi_id"
                    ...
                    <div v-if="errors.instansi_id" class="invalid-feedback">
                      {{ errors.instansi_id }}
                    </div>
                  </div>
  ...
  const props = defineProps(["categories", "instansi"]);
